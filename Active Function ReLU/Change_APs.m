...
%% Inital parameters
M_AP=150:10:200; %number of access points
K=60; %number of terminals
N_Antenna = 4; %number of AP equiped antenna
...
plot(M_AP,rp_T2_satis,'r');
plot(M_AP,rp_T1_satis,'k');
plot(M_AP,rp_H_satis,'b');
plot(M_AP,rp_SVM_satis,'m');
...
% legend('Lemma Method', 'Fully Connected Method','Neural Network Method');
...
plot(M_AP,rp_T2_opt_satis,'r');
plot(M_AP,rp_H_opt_satis,'k');
plot(M_AP,rp_NN_opt_satis,'m');
