...
K_user=40:10:80; %number of terminals
N_Antenna = 6; %number of AP equiped antenna
...
plot(K_user,rp_T2_satis,'r');
plot(K_user,rp_T1_satis,'k');
plot(K_user,rp_H_satis,'b');
plot(K_user,rp_SVM_satis,'m');
...
legend('Lemma Method', 'T Method', 'Fully Connected Method', 'SVM method');
...
plot(K_user,rp_T2_opt_satis,'r');
plot(K_user,rp_H_opt_satis,'k');
plot(K_user,rp_NN_opt_satis,'m');

xlabel('Number of user');
ylabel('Number of user satisfy QoS(%)');

legend('Lemma Method', 'H Method');
